...
ms.locfileid: "52338821"
---
# <a name="whats-new-in-the-azure-toolkit-for-intellij"></a><span data-ttu-id="c191d-103">用于 IntelliJ 的 Azure 工具包中的新增功能</span><span class="sxs-lookup"><span data-stu-id="c191d-103">What's New in the Azure Toolkit for IntelliJ</span></span>

<span data-ttu-id="c191d-104">以下网页包含有关用于 IntelliJ 的 Azure 工具包的不同版本和最新更新的信息。</span><span class="sxs-lookup"><span data-stu-id="c191d-104">The following web page contains information on the various releases and latest updates to the Azure Toolkit for IntelliJ.</span></span>

<https://github.com/Microsoft/azure-tools-for-java/releases>

> [!NOTE] 
> <span data-ttu-id="c191d-105">另外还有 Azure Toolkit for Eclipse IDE。</span><span class="sxs-lookup"><span data-stu-id="c191d-105">There is also an Azure Toolkit for the Eclipse IDE.</span></span> <span data-ttu-id="c191d-106">有关详细信息，请参阅[用于 Eclipse 的 Azure 工具]。</span><span class="sxs-lookup"><span data-stu-id="c191d-106">For more information, see [Azure Toolkit for Eclipse].</span></span> 
> 
...
## <a name="next-steps"></a><span data-ttu-id="c191d-107">后续步骤</span><span class="sxs-lookup"><span data-stu-id="c191d-107">Next steps</span></span>
