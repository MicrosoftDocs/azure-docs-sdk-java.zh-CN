<span data-ttu-id="8c5c0-101">[使用管理 API 配置 Azure SQL 数据库][1] </span><span class="sxs-lookup"><span data-stu-id="8c5c0-101">[Configure Azure SQL Database with the management API][1] </span></span>  
