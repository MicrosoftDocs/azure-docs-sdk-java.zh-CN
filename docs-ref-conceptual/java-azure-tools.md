...
使用用于 [Eclipse](https://docs.microsoft.com/azure/azure-toolkit-for-eclipse) 和 [IntelliJ](https://docs.microsoft.com/azure/azure-toolkit-for-intellij) 的 Azure 工具包通过 IDE 管理 Azure 资源及部署应用。   
